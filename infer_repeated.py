...
for img_no in range(1):
    ...
    # for i, (trace, log_weight) in enumerate(marg):
    #     image = trace.nodes["_RETURN"]["value"]["image"]
    #     print(image.view(200, 200, 3).data.numpy().astype(np.uint8))
    #     img = Image.fromarray(image.view(200, 200, 3).data.numpy().astype(np.uint8))
    #     for j in range(i*5, i*5+5):
    #         img.save("/home/will/Documents/D3m/4yp-slide/posterior/{}.png".format(i))
    #         print("saved at "+"/home/will/Documents/D3m/4yp-slide/posterior/{}.png".format(i))

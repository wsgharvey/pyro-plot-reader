...
parser = argparse.ArgumentParser("run inference with artifact and create videos showing posterior")
...
artifact.make_posterior_videos(args.dataset, cuda=bool(args.cuda), max_plots=args.N)
